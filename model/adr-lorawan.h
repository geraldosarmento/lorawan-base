...
#ifndef ADR_LORAWAN_H
#define ADR_LORAWAN_H
 ...
 */
class AdrLorawan : public NetworkControllerComponent
{
    /**
  ...
  public:
    ...
    AdrLorawan();           //!< Default constructor
    ~AdrLorawan() override; //!< Destructor
  ...
  protected:
    ...
    double GetSdSNR(EndDeviceStatus::ReceivedPacketList packetList, int historyRange);
    ...
    const int max_spreadingFactor = 12;    //!< Spreading factor upper limit
